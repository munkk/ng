...
module.exports = "<q-grid:popup id=\"q-grid-reference-popup\" ng-init=\"$popup.show()\">\n\t<q-grid:template for=\"trigger\">\n\t\t<span ng-init=\"$popup.open({width: 350, height: 500})\"></span>\n\t</q-grid:template>\n\t<q-grid:template for=\"body\" let=\"[$cell]\">\n\t\t<div ng-cloak\n\t\t\t  class=\"q-grid-editor q-grid-reference\"\n\t\t\t  layout=\"column\"\n\t\t\t  ng-controller=\"Body.Cell.Reference.Edit.Controller as $ctrl\">\n\t\t\t<div flex=\"90\">\n\t\t\t\t<q-grid model=\"$ctrl.gridModel\">\n\t\t\t\t\t<q-grid:columns>\n\t\t\t\t\t</q-grid:columns>\n\t\t\t\t\t<q-grid:toolbar>\n\t\t\t\t\t\t<q-grid:template for=\"top\">\n\t\t\t\t\t\t\t<div class=\"q-grid-progress\">\n\t\t\t\t\t\t\t\t<q-grid:progress></q-grid:progress>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</q-grid:template>\n\t\t\t\t\t</q-grid:toolbar>\n\t\t\t\t</q-grid>\n\t\t\t</div>\n\t\t\t<div flex=\"10\" class=\"q-grid-actions\">\n\t\t\t\t<md-button class=\"md-primary md-confirm-button\" ng-click=\"$ctrl.commit($cell, $event)\">Save\n\t\t\t\t</md-button>\n\t\t\t\t<md-button class=\"md-primary md-cancel-button\"\n\t\t\t\t\t\t\t  ng-click=\"$ctrl.cancel($cell, $event)\">Cancel\n\t\t\t\t</md-button>\n\t\t\t</div>\n\t\t</div>\n\t</q-grid:template>\n\t<q-grid:template for=\"head\" let=\"$cell\">\n\t\t<h2 class=\"md-title\">Edit {{::$cell.column.title}}</h2>\n\t</q-grid:template>\n</q-grid:popup>"
...
module.exports = "<div class=\"q-grid-edit-form-panel\" layout=\"column\" flex=\"100\">\n\t<q-grid:edit-form-body row=\"$editFormPanel.row\" register=\"$editFormPanel.register\">\n\t</q-grid:edit-form-body>\n\t\n\t<div class=\"q-grid-edit-form-panel-actions\">\n\t\t<md-button ng-click=\"$editFormPanel.cancel.execute()\">\n\t\t\tCancel\n\t\t</md-button>\n\t\t<md-button ng-click=\"$editFormPanel.reset.execute()\">\n\t\t\tReset\n\t\t</md-button>\n\t\t<md-button class=\"md-primary\"\n\t\t\t\t\t  ng-click=\"$editFormPanel.submit.execute()\">\n\t\t\tApply\n\t\t</md-button>\n\t</div>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__templates_body_cell_reference_edit__ = __webpack_require__(130);
...
function Setup(qgridThemeProvider) {
	qgridThemeProvider.register('material', function (theme) {
		...
		theme.put('qgrid.body.cell.text.edit.tpl.html', __webpack_require__(151));
		theme.put('qgrid.body.cell.text-area.edit.tpl.html', __webpack_require__(150));
		theme.put('qgrid.body.cell.bool.edit.tpl.html', __webpack_require__(136));
		theme.put('qgrid.body.cell.date.edit.tpl.html', __webpack_require__(138));
		theme.put('qgrid.body.cell.number.edit.tpl.html', __webpack_require__(144));
		theme.put('qgrid.body.cell.array.tpl.html', __webpack_require__(134));
		theme.put('qgrid.body.cell.array.edit.tpl.html', __webpack_require__(133));
		theme.put('qgrid.body.cell.password.edit.tpl.html', __webpack_require__(145));
		theme.put('qgrid.body.cell.bool.tpl.html', __webpack_require__(137));
		theme.put('qgrid.body.cell.select.tpl.html', __webpack_require__(149));
		theme.put('qgrid.body.cell.row-indicator.tpl.html', __webpack_require__(148));
		...
		theme.put('qgrid.body.cell.email.tpl.html', __webpack_require__(141));
		theme.put('qgrid.body.cell.email.edit.tpl.html', __webpack_require__(140));
		theme.put('qgrid.body.cell.file.tpl.html', __webpack_require__(142));
		theme.put('qgrid.body.cell.file.edit.tpl.html', __webpack_require__(61));
		theme.put('qgrid.body.cell.image.tpl.html', __webpack_require__(143));
		theme.put('qgrid.body.cell.image.edit.tpl.html', __webpack_require__(61));
		theme.put('qgrid.body.cell.reference.tpl.html', __webpack_require__(147));
		theme.put('qgrid.body.cell.reference.edit.tpl.html', __webpack_require__(146));
		theme.put('qgrid.body.cell.dropdown.edit.tpl.html', __webpack_require__(139));
		theme.put('qgrid.body.cell.autocomplete.edit.tpl.html', __webpack_require__(135));
